...
1. **Global perception**: Read the input **Prompt** in full, observe the input **image**, and form an initial understanding of the overall image structure, main subjects, background, and core knowledge point.
...
# Input Format
User input will contain the image to be evaluated (as image-modal input), the complete Prompt, and a VQA Checklist Dictionary (JSON format) containing multiple checklists. The format is as follows:
